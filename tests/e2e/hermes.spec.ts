...
test("übersetzt alte Session- und Verwaltungs-Deep-Links in Hermes-SPA-Routen", async ({ page }) => {
  await page.goto("/wrapt/hermes-agent?session=session-from-deep-link");
