 ...
 * in `playwright.config.ts`). Die Adresse enthält bereits den Basispfad
 * `/workbench`, unter dem das Frontend ausgeliefert wird.
 *
...
export const workbenchUrl = (process.env.WORKBENCH_E2E_URL ?? "http://127.0.0.1:3010/workbench").replace(/\/$/, "");
