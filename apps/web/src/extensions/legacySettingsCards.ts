...
export const legacySettingsCards: readonly SettingsCardMetadata[] =
  Object.freeze([
    Object.freeze({ id: contributionIdSchema.parse("wrapt.settings.card.version"), title: "Version", description: "Wird aus der Health-Antwort gelesen", order: 10, hostOnly: true }),
    ...
    Object.freeze({ id: contributionIdSchema.parse("wrapt.settings.card.security"), title: "Sicherheit", description: "Keine eigene Anmeldung", order: 110, hostOnly: true }),
  ]);

export function registerLegacySettingsCards(registry: SettingsCardRegistry): void {
  registry.replaceOwner("wrapt.settings", legacySettingsCards);
}
