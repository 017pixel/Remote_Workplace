...
const definitions: readonly BuiltinNavigationDefinition[] = Object.freeze([
  ...
  { extensionId: "workbench.opencode", routeId: "workbench.opencode.route.main", label: "OpenCode", description: "OpenCode CLI im Browser", icon: OpenCodeIcon, group: "tools", order: 50, visibleByDefault: false, preferenceKey: "opencode" },
