...
/**
 * SHA-256 in reinem JavaScript. `crypto.subtle` steht in unsicheren Kontexten
 * (Workbench über plain HTTP im Tailnet) nicht zur Verfügung, der Snapshot-Hash
 * muss aber überall identisch berechenbar sein.
 */
